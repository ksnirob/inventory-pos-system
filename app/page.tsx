import { AlertTriangle, Boxes, DollarSign, FolderTree, Package, PackageX, ShoppingCart, Truck } from "lucide-react";
...
export default async function DashboardPage() {
  const [products, categoryCount, supplierCount, recentTransactions, recentProducts, recentOrders, orderCount] = await Promise.all([
