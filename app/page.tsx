...
import { AlertTriangle, Boxes, FolderTree, PackageX, ShoppingCart, TrendingUp, Truck, Wallet } from "lucide-react";
...
export default async function DashboardPage() {
  ...
  const totalProductPurchasePrice = products.reduce((total, product) => total + Number(product.purchasePrice), 0);
