...
export default async function OrderDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <>
      ...
      <div className="grid items-start gap-6 print:block lg:grid-cols-[minmax(0,1fr)_320px]">
        <div className="grid min-w-0 gap-6 print:hidden xl:grid-cols-[minmax(0,1fr)_360px]">
          <section className="rounded-md border border-stone-200 bg-white p-5 shadow-sm xl:col-span-2">
            <div className="grid gap-5 xl:grid-cols-[minmax(0,1fr)_360px] xl:items-end">
              <div>
                <div className="mb-4 flex flex-wrap items-center gap-3">
                  <h2 className="text-lg font-semibold text-stone-950">Sale status</h2>
                ...
                <dl className="grid gap-3 text-sm sm:grid-cols-3">
                  ...
                  <div>
                    ...
                    <dd className="font-semibold text-stone-950">{order.paymentMethod.replace("_", " ")}</dd>
                  </div>
                  <div>
                    <dt className="text-stone-500">Total</dt>
                    <dd className="font-bold text-stone-950">{formatCurrency(String(order.total))}</dd>
                  </div>
                </dl>
              </div>
          ...
          <aside className="grid gap-6">
            ...
            <section className="rounded-md border border-stone-200 bg-white p-5 shadow-sm">
              ...
              <dl className="grid gap-3 text-sm">
                ...
                <div className="flex justify-between"><dt className="text-stone-500">Amount</dt><dd className="font-semibold">{formatCurrency(String(order.paidAmount))}</dd></div>
        ...
        <section className="grid justify-center print:block lg:justify-start">
